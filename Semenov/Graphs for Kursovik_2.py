...
for O in range(1):
    for Change in range(1,4):
        ...
        def Draw_3d_Sigmas(Function, Values_Result, Type_Sigmas, U_function, V_function, W_Function, z_val, W_val,
                           U_val, V_val):
            x_array = []
            y_array = []
            z_array = [0] * Size
        ...
        def Draw_3d_Sigmas_main(Function, Values_Result, Type_Sigmas, U_function, V_function, W_Function, z_val, W_val,
                                U_val, V_val):
            x_array = []
            y_array = []
            z_array = [0] * Size
        ...
        def Draw_3d_Sigmas_main_Orto(Function, Values_Result, Type_Sigmas, U_function, V_function, W_Function, z_val,
                                     W_val, U_val, V_val):
            x_array = []
            y_array = []
            z_array = [0] * Size
        ...
        def Get_Sigmas_max_values(Function, Values_Result, Type_Sigmas, Sigma_x_Function, Sigma_y_Function,
                                  Tay_xy_Function, z_val, W_val, U_val, V_val):
            x_array = []
            y_array = []
            z_array = [0] * Size
        ...
        def Get_Sigmas_max_values_Orto(Function, Values_Result, Type_Sigmas, U_function, V_function, W_Function, z_val,
                                       W_val, U_val, V_val):
            x_array = []
            y_array = []
            z_array = [0] * Size
        ...
        while Check:
            ...
            if Sigma_max_global > QQ and Only_Value_in_Break_point != 1:
                ...
                Q_now -= Q_max*Coef_step
                Coef_step /= 4

            if Only_Value_in_Break_point and Count_num == 2:
                Check = 0
                Q_now -= Q_max
...
plt.legend(["W l/4 для углепластика " , "W l/2 для углепластика","W l/4 для оргстекла " , "W l/2 для оргстекла","W l/4 для стали " , "W l/2 для стали"])
plt.show()
